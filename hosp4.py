...
trans_probs = np.array([[[0.4, 0.1,0.5],[0.1,0.3,0.6], [0.0,0.0, 1.0]]])
##Entering probs = [entering in specialty 1, entering in specialty 2]
enter_probs = np.array([[0.5,0.5, 0.0]])
#######
bandwidth = 1
...
def main():
    ...
    A=stateSpace((0,0,0), L, E, S)
    print(len(A),A)
    # outputFile(A, "statenspatie4")

    # print(L.isOverUt((0,5,0)))
    # print(actionChecker((0,5,0),L,E,S))
    # print(len(transitioner((7,0,0),L,E,S)))
